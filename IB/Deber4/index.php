	...
	<body>
		<center>
			<center>
				...
				<font size = "+2">
					<strong>
					Cuarto Deber: Métodos Numéricos. <br/>
					</strong>

					Algoritmo para encontrar el intervalo donde cambia <br/>
					el signo de una función y posteriormente por el metodo de la bisección encuentra las raices. <br/>
					<br/>
					<span class = "cmath">
						`[x , x_(i+1)] ` donde  `f(x)*f(x_(i+1))<0 `
					<span/>
				</font>
				</p>
